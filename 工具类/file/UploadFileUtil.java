...
public class UploadFileUtil {
	 ...
	 * @throws Exception
	 */
	public static String upload(String upPath, MultipartFile myfile,String name)throws Exception{
//		String newName = null;
//		if(!ts.isEmpty()){
//			//获取服务器路径
...
//                	String fileName = originalFileName[0]+"."+originalFileName[1];
					...
					//配置图片访问路径					
					imgPathList.add("upload/"+name+"/"+fileName);
                } catch (IOException e) {
					e.printStackTrace();
					return null;
				}  
